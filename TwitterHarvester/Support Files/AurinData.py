...
attributes = 'Support Files/AurinData/age-attributes.csv'
nodes = 'Support Files/AurinData/age-nodes.csv'
attributes2 = 'Support Files/AurinData/edu-emp-attributes.csv'
suburbs = []
suburbDict={}
