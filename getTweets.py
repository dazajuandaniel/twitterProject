...
class TwitterClient(object):
    ...
    def clean_tweet(self, tweet):
        clean={}
        clean['place']=tweet['place']
        clean['text']=tweet['text']
        clean['favorited']=tweet['favorited']
        clean['lang']=tweet['lang']
        clean['retweeted']=tweet['retweeted']
        clean['retweet_count']=tweet['retweet_count']
